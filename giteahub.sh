...
desired_branch="master"  # Change this to "master"
username="SpiXla"
email="aymanaitbihi9@gmail.com"
github_repo="https://github.com/SpiXla/atm.git"
gitea_repo="https://learn.zone01oujda.ma/git/aaitbihi/atm-management-system.git"
